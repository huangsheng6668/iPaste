...
const {
  imageStageElement, imageNaturalSize, imageScale, imageRotation, imagePan, imageViewMode, isImageDragging,
  normalizedImageRotation, canPanImage, isImageActualSize,
